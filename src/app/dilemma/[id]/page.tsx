          ...
          {chat.messages.map((msg, idx) => {
            ...
            return (
              <div key={idx} className={`flex ${isMine ? "justify-end" : "justify-start"} flex-col`}>
                ...
                <div
                  className={`px-4 py-2 rounded-lg max-w-[70%] text-sm font-medium ${
                    isMine ? "bg-gray-200 text-black self-end" : "bg-[#203D68] text-white self-start"
                  }`}
                >
                  {msg.content}
                </div>
